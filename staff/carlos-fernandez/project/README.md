...
Este proyecto es un sistema de reservas para una residencia canina. Los usuarios pueden registrar sus mascotas y gestionar reservas en función de la disponibilidad de la residencia. Está diseñado para impedir realizar una reserva en caso que se supere el aforo de 50 mascotas/dia.
...
- **Usuarios**:
  ...
  - Editar número de teléfono y contraseña

- **Mascotas**:

  - Formulario de registro para registrar mascotas asociadas al usuario.
  - Consultar las mascotas registradas.
  - Posibilidad de eliminarlas de la BBDD.

- **Reservas**:
  - El sistema siempre tendrá en cuenta el aforo de 50 perros/dia.
...
- **Booking schema**:
  ...
  - Dogs - _(array of ObjectID - Mongoose)_
  - StartDate - _(ObjectID - Mongoose)_
  - EndDate - _(ObjectID - Mongoose)_
...
![Diseño UX/UI](ruta/a/la/imagen.png)
...
Ana ya tiene una reserva hecha para su perra Luna, pero necesita añadir también a su perra Kora. Ingresa al sistema, crea una nueva reserva para las mismas de su reserva anterior, pero esta vez selecciona a Kora.
...
# QUE AÑADIRIA EN NUEVAS VERSIONES
