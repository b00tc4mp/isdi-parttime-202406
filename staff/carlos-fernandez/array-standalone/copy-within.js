...
const result1 = copyWithin(['tendria', 'para', 'un', 'café'], 0, 2, 4)
console.assert(result1 === ['tendria', 'para', 'un', 'café'].copyWithin(0, 2, 4), { result: result1, message: 'Test 1 no pasado' });