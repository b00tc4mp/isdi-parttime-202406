...
console.assert(
  result1.value === "¡Me siento bieN, porque eL sofá Es Nuevo!".toLowerCase(),
  {
    result: result1,
...
console.assert(result2.value === "12344ABCDeee".toLowerCase(), {
  result: result2,
  message: "Test 2 no pasado",
});

const result3 = new ChainCharacters("null vaLue").toLowerCase();
console.assert(result3.value === "null vaLue".toLowerCase(), {
  result: result3,
