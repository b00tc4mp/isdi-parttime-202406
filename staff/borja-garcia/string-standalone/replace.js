...
const result2 = replace('Change My Mind: Pineapple Belongs on Pizza', 'Change My Mind', 'Convince Me');
console.assert(result2 === 'Convince Me: Pineapple Belongs on Pizza', {
    result: result2,
    message: 'Test 2 not passed',
});

const result3 = replace('Why You Always Lying? Stop Lying!', 'Why You Always Lying', 'Stop Lying');
