...
function NewPost() {
    ...
    const submitPost = (event) => {
        ...
        try {
            logic.createPost(content, images, visibility)
                .then(() => navigate('/home'))
        ...
        <div className="min-h-screen px-8 pt-3 pb-5">
            ...
            <form className="flex flex-col w-full gap-2" onSubmit={submitPost}>
                ...
                <div className="flex flex-col md:flex-row w-full justify-between">
                    <select defaultValue={"placeholder"} required={true} id="visibility" className="select select-bordered w-full bg-gray-800 max-w-xs">
