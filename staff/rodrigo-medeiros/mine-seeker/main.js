...
(() => {
  ...
  let timeRemaining = 60 * 10; // Tiempo restante en segundos (10 minutos)
  let isRunning = false; // Estado del temporizador, si está corriendo o no
  const initialTime = 60 * 10; // Tiempo inicial del temporizador (10 minutos)
