(() => {
    ...
    const minesTotal = document.getElementById("mintesTotal");
...
changePlayerNameButton.onclick = () => {
    const playerName = prompt("Elige tu nombre de jugador: ");
...
winsInARow.innerText = winsInARow;
};
    ...
    function animateDives() {
        ...
        for (let i = 0; i < cells.length; i++) {
            ...
            cell.onclick = (event) => {
                ...
                if (matrix[positionMatrix[0]][positionMatrix[1]] === "*") {
                    ...
                    for (let i = 0; i < cells.length; i++) {
                        ...
                        cell.classList.add("cell_reveal");
                    ...
                    setTimeout(() => {
                        ...
                        minesFound.innerText = "_";
                        minesTotal.innerText = "_";
                        gamesLost.innerText = winsInARowCounter;
                        clickCounter.innerText = counterClicks;
                    ...
                    event.target.classList.remove("celḷ__");
            ...
            cell.oncontextmenu = (event) => {
                ...
                if (foundMines === 16) {
                    const cells = [...document.cell.getElementsByClassName("cell")];

                    const cellsWithFlags = cells.filter((cell) => 
                    cell.classList.contations("cell__flag")
                );
...
// falta hacer un temporizador como una funcionalidad extra; 